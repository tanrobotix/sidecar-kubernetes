...
def main
  ...
  if ENV['CLUSTER'].nil?
      abort "You must pass CLUSTER= in the environment (i.e. SANDBOX) for what CLUSTER we are generating a cert for"
  end
  ...
  puts "Generated new certs for #{az}-#{cluster} for devops-sidecar-injector"
